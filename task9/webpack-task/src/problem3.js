...
export let ResultOfgetSumOfSquareofOddNumberInOneRowFunction =
  getSumOfSquareofOddNumberInOneRow([1, 2, 3, 4, 5]);

export let ResultOfgetSumOfSquareofOddNumberFunction = getSumOfSquareofOddNumber([
  1, 2, 3, 4, 5,
]);

//функция пузырьковой сортировки
export function bubbleSort(array, direct) {
  if (direct == "asc") {
...
export function getSumOfSquareofOddNumberInOneRow(array) {
...
export function getSumOfSquareofOddNumber(array) {
  sum = 0;
